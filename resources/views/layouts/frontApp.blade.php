...
<head>
    ...
    <meta name="author" content="KaaiKaas"/>
    <!--SEO/FB Metas-->
    ...
    @else
    <meta name="keywords" content="hotels in ithari, cheap hotels in ithari">
    @endif
    <meta name="author" content="KaaiKaas">
...
<nav class="navbar navbar-expand-md navbar-fixed-top navbar-dark bg-dark main-nav" style="position: absolute">
    <div class="container-fluid" id="nv-second">
        <div class="navbar-collapse collapse nav-content order-2">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle lh-fix" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">About</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        @foreach( $pages as $about)
                            <a class="dropdown-item" href="{{ url('/about') }}/{{ $about->slug }}">{{ $about->title }}</a>
                        @endforeach
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle lh-fix" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Rooms</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        @php
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle lh-fix" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Amneties</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        @php
                        ...
                        @foreach($amneties as $amnetie)
                            <a class="dropdown-item" href="{{ asset('amneties') }}/{{ $amnetie->slug }}">{{ $amnetie->title }}</a>
                        @endforeach
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Meetings <br class="d-none d-sm-block">& Groups</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        @php
        ...
        <ul class="nav navbar-nav text-nowrap flex-row mx-md-auto order-1 order-md-2">
            <li class="nav-item"><a href="tel:{{ $setting->phone }}" class="nav-link d-block d-sm-none"><i class="fa fa-phone" style="font-size:18px;"></i></a></li>
            <li class="nav-item logo-holder"><a class="nav-link" href="{{ url('/') }}"><img src="{{ asset('images/logo/logo.png') }}" class="logos logo d-none d-sm-none d-md-block" alt=""><img src="{{ asset('images/logo/logo-sq.png') }}" class="logo-sq d-md-none" alt=""></a></li>
            ...
            <div class="col-sm-8 offset-sm-2">
                <form action="{{url('message')}}" method="post" class="frm">
                    ...
                    <div class="text-center">
                        <input type="submit" class="btn mt16 mb16 btn-filled" name="button" value="Send">
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 pt32 pt-xs-8 fot-text">
                ...
                <ul class="foot-list">
                    <li><a href="#" class="gold cursive-font pt8 pb8"><i
            ...
            <div class="col-sm-4 pt32 pt-xs-8 text-center">
                ...
                <div class="row">
                    <div class="col-4 offset-2 rela">
                        <a href="https://www.booking.com/index.en-gb.html?label=gen173nr-1BCAEoggI46AdIM1gEaKsBiAEBmAEJuAEYyAEM2AEB6AEBiAIBqAIEuAL7rILsBcACAQ;sid=096534acebd238fbe1945b5782a67f64;keep_landing=1&sb_price_type=total&;"><img src="{{asset('./images/logo/bookingcom.png')}}" class="img-fluid" alt="booking.com"></a>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 text-sm-center">
                <h6>@ Copyrights by Hotel Maden Inn 2019</h6>
            </div>
            <div class="col-sm-6">
