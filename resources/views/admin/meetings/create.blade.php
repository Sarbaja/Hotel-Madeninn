    ...
    <div class="col-md-12">
      <div class="card ">
          <div class="card-header card-header-rose card-header-icon">
              ...
              <h4 class="card-title"><b>Create New Meeting Space Here.</b><span><a class="btn btn-rose"
        ...
        <div class="card-body ">
          ...
          <form method="post" action="{{url('admin/meetings')}}" enctype="multipart/form-data"  class="form-horizontal">
            @csrf
