            ...
            <div class="col-md-12">
                <div class="content card">
                    ...
                    <div class="card-header card-header-rose card-header-icon">
                        ...
                        <h4 class="card-title"><b>Manage your Amneties here.</b><span><a class="btn btn-rose"
                                                                        href="{{url('admin/locations/create')}}"><i
                                        class="fa fa-plus"></i> Add Amneties</a></span></h4>
                    </div>
                    <div class="container">
                                    ...
                                    @foreach($locations as $row)
                                        <li class="dd-item" id="{{$row->id}}">
                                            <div class="pull-right item_actions action-section">
                                                <a href="{{url('admin/locations/'.$row->id.'/edit')}}" 
                                                    class="btn btn-sm btn-link btn-primary" 
                                                    data-original-title="Edit Location">
                        ...
                        data: {
                            ...
                            success: function (response) {
                                ...
                                if(obj.status == 'success'){
                                    ...
                                    html: '<b>Location</b> Sorted Successfully',
                                    timer: 1000,
                                    type: "success"
                                    }).catch(swal.noop);
                                }
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h4 class="modal-title danger">Delete Location</h4>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <p>Are you sure want to delete this Location. Contents associated with it will also be deleted!!</p>
                </div>
