            ...
            <div class="col-md-12">
                <div class="content card">
                    ...
                    <div class="card-header card-header-rose card-header-icon">
                        ...
                        <h4 class="card-title"><b>Manage your retails here.</b><span><a class="btn btn-rose"
                                                                        href="{{url('admin/retails/create')}}"><i
                                        class="fa fa-plus"></i> Add Retail</a></span></h4>
                    </div>
                    <div class="container">
                        <div class="nestable-lists">
                            <div class="dd">
                                <ul class="dd-list" id="sortable">
                                    @foreach($retails as $row)
                                        <li class="dd-item" id="{{$row->id}}">
                                            <div class="pull-right item_actions action-section">
                                                <a href="{{url('admin/retails/'.$row->id.'/edit')}}" 
                                                    class="btn btn-sm btn-link btn-primary" 
                                                    data-original-title="Edit Retail">
                                                    <i class="material-icons">edit</i> 
                                                </a>
                                                <a href="#deleteModal"
                                                    data-toggle="modal"
                                                    data-id="{{ $row->id }}"
                                                    onClick="deleteRetail('{{$row->id}}')"
                                                    rel="tooltip" title=""
                                                    class="btn btn-danger btn-link btn-sm"
                                                    data-original-title="Delete Retail">
                        ...
                        data: {
                            ...
                            success: function (response) {
                                ...
                                if(obj.status == 'success'){
                                    ...
                                    html: '<b>Retail</b> Sorted Successfully',
                                    timer: 1000,
                                    type: "success"
                                    }).catch(swal.noop);
                                }
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h4 class="modal-title danger">Delete Retail</h4>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <p>Are you sure want to delete this Retail. Contents associated with it will also be deleted!!</p>
                </div>
