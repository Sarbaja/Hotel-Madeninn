            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <form method="post" action="{{url('admin/blogs')}}" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-sm-offset-1 checkbox-radios">
                                    <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="featured" value="1" checked> Show/hide
                                        <span class="form-check-sign">
                                        <span class="check"></span>
                                        </span>
                                    </label>
