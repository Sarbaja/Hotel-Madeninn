            ...
            <div class="col-md-12">
                <div class="content card">
                    ...
                    <div class="card-header card-header-rose card-header-icon">
                        ...
                        <h4 class="card-title"><b>Manage your events here.</b><span><a class="btn btn-rose"
                                                                        href="{{url('admin/events/create')}}"><i
                                        class="fa fa-plus"></i> Add Events</a></span></h4>
                    </div>
                    <div class="container">
                        ...
                        data: {
                            ...
                            success: function (response) {
                                ...
                                if(obj.status == 'success'){
                                    ...
                                    html: '<b>Event</b> Sorted Successfully',
                                    timer: 1000,
                                    type: "success"
                                    }).catch(swal.noop);
                                }
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h4 class="modal-title danger">Delete Event</h4>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <p>Are you sure want to delete this Event. Contents associated with it will also be deleted!!</p>
                </div>
