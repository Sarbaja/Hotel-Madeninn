            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <form method="post" action="{{url('admin/policy/'. $policy->id)}}" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <img src="{{ asset('uploads/policy/thumbs/thumb_') }}{{ $policy->image }}">
                                        <span class="btn btn-round btn-sm btn-file" style="text-align: center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-sm-offset-1 checkbox-radios">
                                    ...
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="display" value="1" @if($policy->display=='1') checked @endif > Show/hide
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                    <textarea name="description" id="editor1" cols="30" rows="10" class="form-control">{{$policy->description}}</textarea>
                                    </div>
                                </div>
                            </div>
