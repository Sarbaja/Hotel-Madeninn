            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <form method="post" action="{{url('admin/breakfast')}}" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <label for="" class="col-sm-2 col-form-label">Main Image</label>
                                <div class="col-sm-4">
                            ...
                            <div class="row">
                                ...
                                <label class="col-sm-2 col-form-label label-checkbox">Other Images</label>
                                <div class="col-sm-4">
                                    <span class="btn btn-round btn-sm btn-file">
