...
@section ('title', 'Breakfast Images')
...
<div class="fluid-container">
            ...
            <div class="col-md-12">
                <div class="content card">
                    ...
                    <div class="card-header card-header-rose card-header-icon">
                        ...
                        <h4 class="card-title"><b>Breakfast Images</b> <a href="{{url('admin/breakfast')}}" class="btn btn-rose btn-sm">Go Back</a>
                    ...
                    <div class="container">
                        <div class="row">
                            @foreach($breakfast as $row)
                                <div class="col-md-3 col-sm-3 imageContainer">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail">
                                            <img src="{{asset('uploads/breakfastimages/'.$row->image_name)}}" alt="">
                                            <div class="row">
                                ...
                                <!-- <div class="col-md-3">
                                    <img src="{{asset('uploads/breakfastimages/'.$row->image_name)}}" class="img-fluid" alt="" srcset="">
                                </div> -->
                            @endforeach
                        </div>
                    </div>
    ...
    <div class="modal fade" id="addImgModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form action="{{url('admin/breakfast/add-images')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="breakfast_id" value="{{$breakfastId}}">
                <div class="modal-body">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Breakfast Images</label>
                        <div class="col-sm-8">
